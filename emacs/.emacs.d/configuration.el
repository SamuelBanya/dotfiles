...
(when (string= system-name "Samuels-MBP.tampabay.rr.com")
  (defhydra hydra-goof (:color pink
			       :hint nil)
    "
  ^Git Clone Goof Projects^
  ^^^^^^^^^^-----------------------------
  _n_: git clone npm based goof project into ~/hub/worknotes_snyk/testing directory
  _p_: git clone python based goof project into ~/hub/worknotes_snyk/testing directory
  _j_: git clone java based goof project into ~/hub/worknotes_snyk/testing directory
  _a_: git clone gradle based goof project into ~/hub/worknotes_snyk/testing directory
  _d_: git clone dotnet based goof project into ~/hub/worknotes_snyk/testing directory
  _g_: git clone go based goof project into ~/hub/worknotes_snyk/testing directory
  _r_: git clone ruby based goof project into ~/hub/worknotes_snyk/testing directory
  _e_: git clone elixir based goof project into ~/hub/worknotes_snyk/testing directory
  _t_: git clone terraform based goof project into ~/hub/worknotes_snyk/testing directory
  _o_: git clone docker based goof project into ~/hub/worknotes_snyk/testing directory
  _f_: git clone jar files based goof project into ~/hub/worknotes_snyk/testing directory
  _q_: quit
  "
    ("n" shell-command "git clone https://github.com/snyk/goof ~/hub/worknotes_snyk/testing")
    ("p" shell-command "git clone https://github.com/JackuB/python-goof ~/hub/worknotes_snyk/testing")
    ("j" shell-command "git clone https://github.com/snyk/java-goof ~/hub/worknotes_snyk/testing")
    ("a" shell-command "git clone https://github.com/snyk/java-woof ~/hub/worknotes_snyk/testing")
    ("d" shell-command "git clone https://github.com/pstember/dotNet-goof ~/hub/worknotes_snyk/testing")
    ("g" shell-command "git clone https://github.com/pstember/go-goof ~/hub/worknotes_snyk/testing")
    ("r" shell-command "git clone https://github.com/snyk-matt/ruby-goof ~/hub/worknotes_snyk/testing")
    ("e" shell-command "git clone https://github.com/snyk/elixir-goof ~/hub/worknotes_snyk/testing")
    ("t" shell-command "git clone https://github.com/snyk/terraform-goof ~/hub/worknotes_snyk/testing")
    ("o" shell-command "git clone https://hub.docker.com/r/snykdocker/docker-goof ~/hub/worknotes_snyk/testing")
    ("f" shell-command "git clone https://github.com/snyk-schmidtty/goof-jar ~/hub/worknotes_snyk/testing")    
    ("q" nil))

  (global-set-key (kbd "C-!") 'hydra-goof/body))
...
;; Taken from this GitHub post:
;; https://github.com/akermu/emacs-libvterm/issues/376
;; Loop through '/usr/local/bin/bash' or '/bin/bash' to find the bash shell and set the 'SHELL' environment variable accordingly
